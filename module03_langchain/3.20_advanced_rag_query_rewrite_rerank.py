...
def retrieve(query: str, docs: list[Doc], k: int = 3) -> list[Doc]:
...
def answer_with_context(query: str, docs: list[Doc]) -> str:
...
if __name__ == "__main__":
    corpus = [
        Doc("m1", "Tools fetch fresh external data during execution."),
        Doc("m2", "Memory preserves prior turns and supports continuity."),
        Doc("m3", "Context compaction reduces token load while preserving essentials."),
        Doc("m4", "Caching and routing can reduce latency and cost."),
    ]
